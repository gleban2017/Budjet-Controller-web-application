...
var BudgetController = (function() {
    ...
    return {
        addItem: function(type, des, val){
            ...
            //Create new Item base don inc or exp type
            if(type ==='exp'){
        ...
        deleteItem: function(type, id){
            ...
            //find indes of searched id within array
   ...
   var formatNumber=function(num, type){
    ...
    return {
        ...
        displayMonth: function(){
            ...
            months=['January','Febraury','March','May','June','July','August','September','October','November','December'];
            month=now.getMonth();
